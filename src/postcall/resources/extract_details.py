...
class ExtractDetailsResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> ExtractDetailsResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/postcall-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> ExtractDetailsResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/postcall-python#with_streaming_response
        """
